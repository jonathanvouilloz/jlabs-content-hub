/**
 * Publication contrôlée des deux avis Ilias résolus le 2026-09-02.
 *
...
// Lot séparé et immuable après confirmation d'Ilias dans le roster canonique.
const candidates = ILIAS_REVIEW_PREPARATIONS;
if (candidates.length !== 2) {
  throw new Error(`Périmètre Ilias inattendu : ${candidates.length}/2 avis.`);
}
