/**
 * Publication contrôlée du lot Barber Concept préparé le 2026-09-26.
 *
...
import { REVIEW_PREPARATIONS } from './reply-reviews-2026-09-26.data.js';
...
// Lot de 9 avis 5★ (dont 1 réconciliation sans PUT), mentions classifiées dans l'artefact daté.
const candidates = REVIEW_PREPARATIONS;
if (candidates.length !== 9) {
  throw new Error(`Périmètre autorisé inattendu : ${candidates.length}/9 avis.`);
}
