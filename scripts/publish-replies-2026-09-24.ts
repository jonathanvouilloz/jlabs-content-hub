/**
 * Publication contrôlée du lot Barber Concept préparé le 2026-09-24.
 *
...
import { REVIEW_PREPARATIONS } from './reply-reviews-2026-09-24.data.js';
...
if (candidates.length !== 3) {
  throw new Error(`Périmètre autorisé inattendu : ${candidates.length}/3 avis.`);
}
