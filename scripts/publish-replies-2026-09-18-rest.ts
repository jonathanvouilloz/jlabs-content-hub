/**
 * Publication contrôlée du lot Barber Concept préparé le 2026-09-18-rest.
 *
...
import { REVIEW_PREPARATIONS } from './reply-reviews-2026-09-18-rest.data.js';
...
if (candidates.length !== 2) {
  throw new Error(`Périmètre autorisé inattendu : ${candidates.length}/2 avis.`);
}
