...
<div class="flex flex-col h-[calc(100vh-73px)] -mx-6 -my-6 lg:-mx-8">
	...
	<div class="flex-shrink-0 px-6 pt-6 pb-4 lg:px-8">
		<h1 class="text-xl font-semibold text-surface-900">Articles</h1>
	...
	<div class="flex flex-1 min-h-0">
		...
		<div class="flex-1 overflow-y-auto px-6 pb-6 lg:px-8">
			...
			<div class="mt-8">
				<div class="flex items-center justify-between">
					<h2 class="text-xs font-semibold uppercase tracking-wider text-surface-400">Articles publies</h2>
		...
		<!-- Right: preview -->
		{#if previewId}
			<div class="w-[55%] flex-shrink-0 overflow-hidden pr-6 pb-6 lg:pr-8">
				<ContentPreview
					contentId={previewId}
					projectSlug={data.project.slug}
