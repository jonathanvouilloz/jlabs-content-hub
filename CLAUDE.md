...
**Prochaine étape :** **REP-004 lot 2** (rétention du détail + `/seo-archive`) ou le **portage de `/positions` sur le canon** (ex-onglet « Mots-clés »). **FIND-007** reste `BLOCKED` sur GSC-005. Détail : `docs/HANDOFF.md`.
