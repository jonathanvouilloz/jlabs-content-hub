...
**Prochaine étape :** **IDX-004 lot 2** (cadence quotidienne `scope: 'due'`, J+3/J+7/J+28 à la publication, CLI d'audit borné) ou **DASH-003** (cockpit projet). Détail : `docs/HANDOFF.md`.
