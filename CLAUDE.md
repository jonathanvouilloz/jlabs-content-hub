...
**Prochaine étape :** **REP-004** (historique et comparaison, qui rend la révision d'un `partial` possible — l'écran Rapports le dit désormais à chaque ligne) ou le **portage de `/positions` sur le canon** (ex-onglet « Mots-clés »). **FIND-007** reste `BLOCKED` sur GSC-005. Détail : `docs/HANDOFF.md`.
