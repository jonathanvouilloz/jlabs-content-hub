...
**Prochaine étape :** **FIND-008** (cannibalisation persistante, **P0**, dernière case de la gate M2 avec FIND-007) ou **REP-004** (historique et comparaison, qui rend la révision d'un `partial` possible). Détail : `docs/HANDOFF.md`.
